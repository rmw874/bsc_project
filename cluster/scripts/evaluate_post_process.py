...
def main():
    ...
    output_dir = "results/evaluation/DeepLabv3-PostProcess-350-Evaluation-1750-40"
    ...
    model.load_state_dict(torch.load('results/DeepLab3_ResNet50_Tversky_350/best_model.pth'))
    ...
    with torch.no_grad():
        for idx in tqdm(range(len(val_dataset)), desc="Processing images"):
            ...
            processed_pred = post_process_mask(logits, 1750, 40)
